...
export const projects: ProjectData[] = [
  ...
  // },
  {
    ...
    visual: "gantt",
    links: {
      code: "https://github.com/LAFruto/MCMeet",
      video: "https://youtu.be/RmAbrai9WrI",
    },
    images: [
      "/MCMeet/mockup.webp",
      "/MCMeet/agenda.webp",
  ...
  },
  {
    ...
    role: "Backend and AI integration developer",
    findings: [
      "Integrated WhisperX speech-to-text with phoneme alignment, obtaining character-level timing paired with acoustic analysis for lexical stress analysis.",
    ...
    images: ["/SpeechCoach/mockup.webp", "/SpeechCoach/mockup2.webp"],
    otherImages: [
      {
        title: "System Architecture",
        label: "Infrastructure",
  ...
  },
  {
    ...
    shortDescription:
      "Co-authored IoT coop surveillance system running YOLOv8s object detection.",
    role: "IOT & AI developer",
    findings: [
      "Successfully built and trained YOLOv8s model that accurately identified local native chickens with 92.8% precision under normal coop lighting (day light) conditions.",
